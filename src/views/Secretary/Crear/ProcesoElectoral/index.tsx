...
import { Button, DatePicker, Divider, Icon, Input, InputNumber, message, Row, Select, Tabs, Transfer, Typography, Upload } from 'antd';
...
function changefecha(value: any, fechas: any) {
  let start = new Date(value[0].valueOf())
  let end = new Date(value[1].valueOf())
}
      ...
      <br />
        ...
        Máximo número de votaciones
          ...
          <InputNumber
            ...
            <br />
            <br />
            <Button style={{ background: '#206489',color:'#FFFFFF',width:"150px", marginLeft:"0px", marginBottom:"30px", marginRight:"50px"}}>Cancelar</Button>
