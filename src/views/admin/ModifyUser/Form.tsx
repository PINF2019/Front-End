import { useModifyUserMutation, useLogInMutation } from '@Generated/hooks'
    ...
    <Formik
      ...
      {() => (
        ...
        <Form>
          ...
          <Form.Item name="name">
          <p style={{ fontSize: "20px" }}><strong>Nombre</strong><Input name="name" value={props.name} autoComplete="nombre" placeholder="Nombre" /></p>
          </Form.Item>
          <Form.Item name="lastnames">
          <p style={{ fontSize: "20px" }}><strong>Apellidos</strong><Input name="lastnames" value={props.lastnames} autoComplete="lastnames" placeholder="Apellidos" /></p>
          </Form.Item>
          <Form.Item name="sex">
            <p style={{ fontSize: "20px" }}><strong>Género</strong><Field as="select" value={props.sex} name="sex">
          ...
          <Form.Item name="rol">
            <p style={{ fontSize: "20px" }}><strong>Rol</strong><Field as="select" value={props.rol} name="rol">
